Attribute VB_Name = "模块_extractNumberFromString"
Option Explicit

'从字符串sStr中提取第iNum个数字串的通用函数：
'修改自 officefans.net 『 VBA交流 』版主“小fisher”的代码

Function extractNumberFromString(sStr As String, iNum As Integer) As Single
    ...
    With regEx
        ...
        If mc.Count >= iNum Then
            extractNumberFromString = mc(iNum - 1).Value
        '否则报告错误
        'Else
